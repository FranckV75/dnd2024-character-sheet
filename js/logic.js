// =============================================================================
// LOGIC.JS - CALCULS D&D PURS (SANS ACCÈS DOM, MODULE ES6)
// =============================================================================
 ...
 */
export function calculateSkillBonus(statMod, isProficient, hasExpertise, proficiencyBonus) {
 ...
 */
export function getClassResourceInfo(level, className, mods) {
...
/**
 * Lit la configuration personnalisée d'une ligne d'arme.
 * @param {HTMLElement} tr
 * @returns {Object}
 */
export function getWeaponConfig(tr) {
    try {
...
/**
 * Résout la caractéristique d'attaque effective d'une arme.
 * @param {string} atkKey
 * @param {string} prop
 * @param {Object} mods
 ...
 */
export function resolveWeaponAttackStat(atkKey, prop, mods, statOverride) {
 ...
 * @param {Object} mods
 * @param {number} pb
 * @param {number} magicBonus
 * @param {string} statOverride
 * @returns {{ text: string, tooltip: string }}
 */
export function calcWeaponAttack(atkKey, prop, mods, pb, magicBonus, statOverride) {
...
/**
 * Calcule la chaîne de dégâts finale d'une arme.
 * @param {string} baseDmg
 * @param {string} prop
 * @param {Object} mods
 * @param {number} magicBonus
 * @param {string} statOverride
 * @param {string} dmgDieOverride
 * @param {string} dmgTypeOverride
 * @param {string} atkKey
 * @param {Array}  extraDmg
 * @returns {{ text: string, tooltip: string }}
 */
export function calcWeaponDamage(baseDmg, prop, mods, magicBonus, statOverride, dmgDieOverride, dmgTypeOverride, atkKey, extraDmg) {
 ...
 * @returns {number}
 */
export function getRageBonus(level) {
...
/**
 * Vérifie si une arme peut bénéficier des Arts Martiaux du Moine (D&D 2024).
 * @param {string}  category
 * @param {boolean} isRanged
 * @param {string}  prop
 * @returns {boolean}
 */
export function isMartialArtsWeapon(category, isRanged, prop) {
...
/**
 * Dé d'Arts Martiaux du Moine selon le niveau (D&D 2024).
 * @param {number} level
 * @returns {string}
 */
export function getMartialArtsDie(level) {
