...
const DD_RULES = {
    ...
    weapons: [
        ...
        { name: "Javeline", atk: "FOR", dmg: "1d6 perf.", prop: "Lancer (9/36 m)", prof: "Ralentissement", ammo: "-" },
        { name: "Lance", atk: "FOR", dmg: "1d6 perf.", prop: "Lancer (6/18 m), Polyvalente (1d8)", prof: "Sape", ammo: "-" },
        ...
        { name: "Arc court", atk: "DEX", dmg: "1d6 perf.", prop: "Munitions (24/96 m), Deux mains", prof: "Ouverture", ammo: "-" },
        { name: "Fléchette", atk: "DEX", dmg: "1d4 perf.", prop: "Finesse, Lancer (6/18 m)", prof: "Ouverture", ammo: "-" },
        { name: "Fronde", atk: "DEX", dmg: "1d4 cont.", prop: "Munitions (9/36 m)", prof: "Ralentissement", ammo: "-" },

        // ARMES DE GUERRE DE CORPS À CORPS
        { name: "Cimeterre", atk: "DEX", dmg: "1d6 tran.", prop: "Finesse, Légère", prof: "Coup double", ammo: "-" },
        { name: "Épée à deux mains", atk: "FOR", dmg: "2d6 tran.", prop: "Lourde, Deux mains", prof: "Écorchure", ammo: "-" },
